...
$APPLICATION->SetPageProperty("title", "Как оформить заказ | Чайно-кофейная компания «Легенда Чая»");
$APPLICATION->SetPageProperty("description", "Оформить заказ на нашем сайте легко. Просто добавьте выбранные товары в корзину, а затем перейдите на страницу Корзина, проверьте правильность заказанных позиций и нажмите кнопку «Оформить заказ» или «Быстрый заказ». Заказывайте по ☎️: 8 800 700-78-87.");
