...
$APPLICATION->SetPageProperty("description", "Наш магазин чайно-кофейная компания «Легенда Чая» продает чай, кофе и другую продукцию с гарантией качества. Узнайте, как вы можете вернуть товар, если вас не устроило качество продукта.");
$APPLICATION->SetPageProperty("title", "Условия гарантии на товар | Чайно-кофейная компания «Легенда Чая»");
