...
$APPLICATION->SetPageProperty("title", "Услуги | Чайно-кофейная компания «Легенда Чая»");
$APPLICATION->SetPageProperty("description", "Нужен кофе под вашим брендом, розничные этикетки для продажи в магазине, консультация с ассортиментом? Разработаем, внедрим и сделаем. С блестящими результатами и стабильной работой, которую оцените и вы, и ваши клиенты!");
