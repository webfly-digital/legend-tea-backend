...
$APPLICATION->SetPageProperty("description", "Информация о сотрудниках чайно-кофейной компании «Легенда Чая». Наши специалисты прошли обучение и сертификацию по международным стандартам определения качества кофе и его обжарки.");
$APPLICATION->SetPageProperty("title", "Информация о сотрудниках | Чайно-кофейная компания «Легенда Чая»");
