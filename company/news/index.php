...
$APPLICATION->SetPageProperty("title", "Новости чайно-кофейной компании «Легенда Чая»");
$APPLICATION->SetPageProperty("description", "В этом разделе мы делимся с вами новостями компании «Легенда Чая», а также о чае и кофе, пишем о ценах и новых подборках товаров. Заказывайте по ☎️: 8 800 700-78-87.");
