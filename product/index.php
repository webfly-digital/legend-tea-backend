...
Asset::getInstance()->addCss("/product/style.css");
Asset::getInstance()->addJs("/product/script.js");
...
$sectionInfo = CIBlockElement::getList([],['IBLOCK_ID'=>$arParams["IBLOCK_ID"], 'CODE'=>$_REQUEST['ELEMENT_CODE']],false,false,['IBLOCK_SECTION_ID'])->fetch();
$arResult = [
    'VARIABLES'=>[
		'ELEMENT_CODE'=>$_REQUEST['ELEMENT_CODE'],
		'SECTION_ID'=>$sectionInfo['IBLOCK_SECTION_ID']
	]
];
...
if(strlen(trim($arResult["VARIABLES"]["ELEMENT_CODE"])) > 0)
