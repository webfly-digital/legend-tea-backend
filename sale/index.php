...
$APPLICATION->SetPageProperty("description", "Акции на покупку кофе и чая оптом и в розницу по доступной цене с доставкой по всей России. Заказывайте по ☎️: 8 800 700-78-87.");
$APPLICATION->SetPageProperty("title", "Акции | Чайно-кофейная компания «Легенда Чая»");
