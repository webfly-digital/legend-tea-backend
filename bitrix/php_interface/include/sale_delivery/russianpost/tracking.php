...
Loader::registerAutoLoadClasses(
	null,
	array(
		'\Sale\Handlers\Delivery\RussianpostHandler' => '/bitrix/php_interface/include/sale_delivery/russianpost/handler.php',
	)
);
/**
 * Class SpsrTracking
 ...
 */
class RussianpostTracking extends \Bitrix\Sale\Delivery\Tracking\Base
{
	...
	{
		return Loc::getMessage("SALE_DLV_RUSSIANPOST_POST_TRACKING_TITLE");
	}
	...
	public function getClassDescription()
	{
		return Loc::getMessage(
			"SALE_DLV_RUSSIANPOST_POST_TRACKING_DESCR",
			array(
				'#A1#' => '<a target="_blank" href="https://pochta.ru/">',
				'#A2#' => '</a>'
			)
		);
	}
	...
	{
		return 'https://pochta.ru/tracking#'.$trackingNumber;
	}
}