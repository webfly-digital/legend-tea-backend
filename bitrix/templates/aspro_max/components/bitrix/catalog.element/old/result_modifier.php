...
<?php
//todo выбираем торговые предложения

/*foreach ($arResult['SKU_PROPS'] as $off) {
    $arResult["OFFERS_WEBFLY"][] = $off;
}*/

$properties =  CIBlockPropertyEnum::GetList(["SORT"=>"ASC"],['CODE'=> ['UPAKOVKA', 'POMOL'], 'IBLOCK_ID'=> 94]);
while ($prop_fields = $properties->GetNext())
{

        $arResult["OFFERS_WEBFLY"]['PROPS'][$prop_fields['PROPERTY_CODE']][] = $prop_fields;
